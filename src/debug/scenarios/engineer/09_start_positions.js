...
/**
 * Engineer - Start Positions
 * Crew perspective: Engineer sees "AWAITING CAPTAINS" in their control panel swap area.
 * Timeline simulates the captains completing selection, then transition to LIVE.
 */
export default {
    name: 'Engineer - Start Positions',
    description: 'Engineer sees crew interrupt panel while captains select positions.',
    scene: 'engineer',
    playerId: PLAYER_ROLES.ENG,
